...
import  ProfileModalSpecific  from "./miscellaneous/ProfileModalSpecific";
            ...
            <>
                ...
                >
                    ...
                    {!selectedChat.isGroupChat ? (
                        <>
                        <Text textColor="HighlightText" fontWeight="bold">
                        {getSender(user, selectedChat.users)}
                        </Text>
                        <ProfileModalSpecific user={getSenderFull(user, selectedChat.users)} />
                      </>
                    ) : (
                        <>
                        <Text textColor="HighlightText" fontWeight="bold">
